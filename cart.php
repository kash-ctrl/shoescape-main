...
// echo "<pre>";
// print_r(header_remove('Location'));
// die();
        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
                    <li class="breadcrumb-item"><a class="text-nowrap" href="/shoeshopv2/"><i class="ci-home"></i>Home</a></li>
    ...
    <div class="row">
        ...
        <section class="col-lg-8">
            ...
            <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom">
                <div class="d-block d-sm-flex align-items-center text-center text-sm-start"><a class="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="product.php?id=<?= $item['gst_id'] ?>"><img src="<?= get_image_thumb($item['photos']) ?>" width="160" alt="Product"></a>
                    <div class="pt-2">
                ...
                <form action="cart.php" method="get">
                    <input type="hidden" name="sst_id" value="<?= $item['sst_id'] ?>">
                    <label class="form-label" for="quantity">Quantity</label>
                    <input class="form-control" type="number" onchange="this.form.submit()" name="quantity" min="1" value="<?= $item['quantity'] ?>">
                    <!-- <button class="btn btn-sm" type="submit" value="submit">Change</button> -->
                    <button class="btn btn-link px-0 text-danger" type="button"><i class="ci-close-circle me-2"></i><span class="fs-sm"><a href="./src/logicFiles/cart-process-remove.php?id=<?= $item['sst_id'] ?>">Remove</a></span></button>
                </form>
                </div>
            </div>
            <?php } ?>
            ...
            <button class="btn btn-outline-accent d-block w-100 mt-4" onclick="javascrtipt: location.reload()" type="button"><i class="ci-loading fs-base me-2"></i>Update cart</button>
        </section>
        <!-- Sidebar-->
            ...
            <div class="bg-white rounded-3 shadow-lg p-4">
                <div class="py-2 px-xl-2">
                    <div class="text-center mb-4 pb-3 border-bottom">
                        ...
                        <h3 class="fw-normal">₹<?= $cart_total ?></h3>
                    </div>
                    <div class="mb-3 mb-4">
                    ...
                    <a class="btn btn-primary btn-shadow d-block w-100 mt-4" href="checkout.php"><i class="ci-card fs-lg me-2"></i>Proceed to Checkout</a>
                </div>
            </div>
        </aside>
    </div>
